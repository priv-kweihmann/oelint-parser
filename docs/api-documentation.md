...
* [oelint\_parser.cls\_item](#oelint_parser.cls_item)
  ...
  * [AddFragements](#oelint_parser.cls_item.AddFragements)
    * [\_\_init\_\_](#oelint_parser.cls_item.AddFragements.__init__)
    * [Path](#oelint_parser.cls_item.AddFragements.Path)
...
<a id="oelint_parser.cls_item.AddFragements"></a>
...
<a id="oelint_parser.cls_item.AddFragements.__init__"></a>
...
<a id="oelint_parser.cls_item.AddFragements.Variable"></a>
...
<a id="oelint_parser.cls_item.AddFragements.Flagged"></a>
...
<a id="oelint_parser.cls_item.AddFragements.get_items"></a>
...
- `flags` _int, optional_ - flags modifying expression behaviour
...
- `pattern` _str_ - regex pattern
- `string` _str_ - input string
- `maxsplit` _int, optional_ - if nonzero, at most `maxsplit` splits occur
- `flags` _int, optional_ - flags modifying expression behaviour
- `timeout` _int, optional_ - Timeout for operation. On timeout `default` will be returned. Defaults to 5.
- `default` __type_, optional_ - Default to return on timeout. Defaults to None.
...
- `string` _str_ - input string
- `count` _int, optional_ - if nonzero, at most `count` occurrences are replaced
- `flags` _int, optional_ - flags modifying expression behaviour
- `timeout` _int, optional_ - Timeout for operation. On timeout `default` will be returned. Defaults to 5.
