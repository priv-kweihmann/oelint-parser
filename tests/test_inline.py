...
class OelintParserInlineReplacements(unittest.TestCase):
    ...
    def test_oe_vartrue(self):
        ...
        _stash = self.__stash.GetItemsFor(classifier=Variable.CLASSIFIER,
                                          attribute=Variable.ATTR_VAR, attributeValue="VAR_VARTRUE")
    ...
    def test_oe_less_or_equal(self):
        from oelint_parser.cls_stash import Stash
        from oelint_parser.cls_item import Variable
        self.__stash = Stash()
        self.__stash.AddFile(OelintParserInlineReplacements.RECIPE)
        ...
        _stash = self.__stash.GetItemsFor(classifier=Variable.CLASSIFIER,
                                          attribute=Variable.ATTR_VAR, attributeValue="VAR_OE_LESS_OR_EQUAL")
    ...
    def test_oe_version_less_or_equal(self):
        from oelint_parser.cls_stash import Stash
        from oelint_parser.cls_item import Variable
        self.__stash = Stash()
        self.__stash.AddFile(OelintParserInlineReplacements.RECIPE)
        ...
        _stash = self.__stash.GetItemsFor(classifier=Variable.CLASSIFIER,
                                          attribute=Variable.ATTR_VAR, attributeValue="VAR_OE_VERSION_LESS_OR_EQUAL")
    ...
    def test_oe_both_contain(self):
        ...
        _stash = self.__stash.GetItemsFor(classifier=Variable.CLASSIFIER,
                                          attribute=Variable.ATTR_VAR, attributeValue="VAR_OE_BOTH_CONTAIN")
